                    ...
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          ...
                          title={`${star} sao`}
                        >
                          <span className={`material-symbols-outlined text-4xl fill-current transition-colors cursor-pointer ${
                            star <= (hoverRating || newRating) ? 'text-accent' : 'text-gray-300 dark:text-gray-600 hover:text-accent/50'
                          }`}>
                            star
                          </span>
                        </button>
